...
const photos = [
  { src: "/projects/alodariya-house/1.jpg", label: "Bedroom Mirror View" },
  { src: "/projects/alodariya-house/2.jpg", label: "Arched Console Unit" },
  { src: "/projects/alodariya-house/3.jpg", label: "Console & Wardrobe" },
  { src: "/projects/alodariya-house/4.jpg", label: "Mirror Detail" },
  { src: "/projects/alodariya-house/5.jpg", label: "Kitchen Island" },
  { src: "/projects/alodariya-house/6.jpg", label: "Living Room Lounge" },
  { src: "/projects/alodariya-house/7.jpg", label: "LED Accent Wall" },
];

const highlights = [
  { icon: "🏠", label: "Residential" },
  { icon: "🪞", label: "Timeless Design" },
  { icon: "🌿", label: "Organic Forms" },
  { icon: "☁️", label: "Crafted Comfort" },
];

export default function TheAlodariyaHouse() {
  ...
  return (
    <main className="min-h-screen bg-[#faf9f7]">
      ...
      <div className="relative h-[70vh] overflow-hidden">
        <motion.img
          src="/projects/alodariya-house/1.jpg"
          alt="The Alodariya House"
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-16">
        ...
        >
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-6">
            This is <i>Crafting Spaces, Creating Stories</i> in a physical form. The space doesn&apos;t shout luxury — it whispers comfort. It&apos;s not trend-driven. The palette is timeless, the forms are organic, and the comfort is real. Designed for bare feet, coffee spills, and Sunday naps as much as it is for photos.
          </p>
        </motion.div>
